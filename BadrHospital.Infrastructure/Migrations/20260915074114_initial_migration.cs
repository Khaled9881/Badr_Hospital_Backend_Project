        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_DoctorSchedule_EndTime_GreaterThan_StartTime", "[EndTime] > [StartTime]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DispensingItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DispensingItems_Dispensings_DispensingId",
                        column: x => x.DispensingId,
                        principalTable: "Dispensings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DispensingItems_MedicineBatches_MedicineBatchId",
                        column: x => x.MedicineBatchId,
                        principalTable: "MedicineBatches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DispensingItems_PrescriptionItems_PrescriptionItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceItems_LabOrderItems_LabOrderItemId",
                        column: x => x.LabOrderItemId,
                        principalTable: "LabOrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DispensingItems_DispensingId",
                table: "DispensingItems",
                column: "DispensingId");

            migrationBuilder.CreateIndex(
                name: "IX_DispensingItems_MedicineBatchId",
                table: "DispensingItems",
                column: "MedicineBatchId");

            migrationBuilder.CreateIndex(
                name: "IX_DispensingItems_PrescriptionItemId",
                table: "DispensingItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceItems_ConsultationId",
                table: "InvoiceItems",
                column: "ConsultationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceItems_LabOrderItemId",
                table: "InvoiceItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineBatches_ExpirationDate",
